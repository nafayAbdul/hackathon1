...
const HeroSection = () => {
  ...
  return (
    <section className="hero-section">
      {/* Temporarily removing ParticleBackground to test if it's causing the error */}
      {/* <ParticleBackground /> */}
      <div className="hero-content-container">
        <div className={`hero-content ${isVisible ? 'fade-in-up' : ''}`}>
          ...
          <p className={`hero-subtitle ${isVisible ? 'fade-in-up' : ''}`} style={{transitionDelay: '0.2s'}}>
          ...
          <div className={`hero-stats ${isVisible ? 'fade-in-up' : ''}`} style={{transitionDelay: '0.4s'}}>
          ...
          <div className={`hero-cta-container ${isVisible ? 'fade-in-up' : ''}`} style={{transitionDelay: '0.6s'}}>
